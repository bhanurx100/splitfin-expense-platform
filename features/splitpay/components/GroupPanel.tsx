    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/30 p-4 sm:items-center">
      <div className="w-full max-w-sm rounded-2xl bg-white p-5 shadow-xl">
        ...
        <input
          ...
          className="mb-5 h-11 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 text-[14px] text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-400 focus:bg-white"
        />
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="rounded-lg p-1.5 text-slate-300 opacity-0 transition hover:bg-red-50 hover:text-red-400 group-hover:opacity-100"
...
export function GroupList() {
  const { groups, activeGroupId, setActiveGroup, resetToDemo } =
    useGroupStore();
