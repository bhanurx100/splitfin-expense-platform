...
const DEMO_ACCOUNTS: DemoAccount[] = [
  { id: "demo-hdfc",   name: "HDFC Savings",      gradient: "from-blue-600 to-blue-400"    },
  { id: "demo-icici",  name: "ICICI Credit Card",  gradient: "from-violet-600 to-violet-400" },
  { id: "demo-sbi",    name: "SBI Salary Account", gradient: "from-emerald-600 to-emerald-400" },
];
...
function buildDemoTransactions(): DemoTransaction[] {
  ...
  txs.push(
    { id: "dt-sal-1", date: dateStr(28), category: "Salary", categoryId: "demo-cat-salary", payee: "TechCorp India Ltd", amount: 95000, account: "SBI Salary Account", accountId: "demo-sbi", notes: "Monthly salary" },
    { id: "dt-sal-2", date: dateStr(58), category: "Salary", categoryId: "demo-cat-salary", payee: "TechCorp India Ltd", amount: 95000, account: "SBI Salary Account", accountId: "demo-sbi", notes: "Monthly salary" },
    { id: "dt-sal-allow-1", date: dateStr(14), category: "Salary", categoryId: "demo-cat-salary", payee: "TechCorp India Ltd", amount: 12000, account: "SBI Salary Account", accountId: "demo-sbi", notes: "Conveyance allowance" },
  );

  // Rent
  txs.push(
    { id: "dt-rent-1", date: dateStr(26), category: "Rent", categoryId: "demo-cat-rent", payee: "Prestige Properties", amount: -28000, account: "HDFC Savings", accountId: "demo-hdfc" },
    { id: "dt-rent-2", date: dateStr(56), category: "Rent", categoryId: "demo-cat-rent", payee: "Prestige Properties", amount: -28000, account: "HDFC Savings", accountId: "demo-hdfc" },
  );

  // Utilities
  txs.push(
    { id: "dt-bescom",   date: dateStr(23), category: "Utilities", categoryId: "demo-cat-utilities", payee: "BESCOM Electricity", amount: -1840, account: "HDFC Savings", accountId: "demo-hdfc" },
    { id: "dt-airtel",   date: dateStr(23), category: "Utilities", categoryId: "demo-cat-utilities", payee: "Airtel Broadband",   amount: -999,  account: "HDFC Savings", accountId: "demo-hdfc" },
    { id: "dt-bwssb",    date: dateStr(23), category: "Utilities", categoryId: "demo-cat-utilities", payee: "BWSSB Water",        amount: -380,  account: "HDFC Savings", accountId: "demo-hdfc" },
    { id: "dt-bescom-2", date: dateStr(53), category: "Utilities", categoryId: "demo-cat-utilities", payee: "BESCOM Electricity", amount: -2120, account: "HDFC Savings", accountId: "demo-hdfc" },
    { id: "dt-airtel-2", date: dateStr(53), category: "Utilities", categoryId: "demo-cat-utilities", payee: "Airtel Broadband",   amount: -999,  account: "HDFC Savings", accountId: "demo-hdfc" },
  );

  // Investments/SIP
  txs.push(
    { id: "dt-sip-1", date: dateStr(23), category: "Investments", categoryId: "demo-cat-investments", payee: "Zerodha Coin SIP",     amount: -5000, account: "SBI Salary Account", accountId: "demo-sbi", notes: "Monthly SIP" },
    { id: "dt-sip-2", date: dateStr(23), category: "Investments", categoryId: "demo-cat-investments", payee: "HDFC Mutual Fund SIP", amount: -3000, account: "SBI Salary Account", accountId: "demo-sbi", notes: "Monthly SIP" },
    { id: "dt-sip-3", date: dateStr(53), category: "Investments", categoryId: "demo-cat-investments", payee: "Zerodha Coin SIP",     amount: -5000, account: "SBI Salary Account", accountId: "demo-sbi", notes: "Monthly SIP" },
  );

  // Subscriptions
  txs.push(
    { id: "dt-netflix",  date: dateStr(18), category: "Entertainment", categoryId: "demo-cat-entertainment", payee: "Netflix India",     amount: -649, account: "ICICI Credit Card", accountId: "demo-icici" },
    { id: "dt-spotify",  date: dateStr(18), category: "Entertainment", categoryId: "demo-cat-entertainment", payee: "Spotify Premium",   amount: -119, account: "ICICI Credit Card", accountId: "demo-icici" },
    { id: "dt-hotstar",  date: dateStr(48), category: "Entertainment", categoryId: "demo-cat-entertainment", payee: "Hotstar Disney+",   amount: -299, account: "ICICI Credit Card", accountId: "demo-icici" },
  );
  ...
  for (let d = 0; d < 60; d++) {
    ...
    if (d % 7 < 5 && rand(0, 10) > 3) {
      ...
      txs.push({
        ...
        payee: m.payee,
        amount: -rand(m.range[0], m.range[1]),
        account: pick(["HDFC Savings", "ICICI Credit Card"]) === "HDFC Savings" ? "HDFC Savings" : "ICICI Credit Card",
  ...
  persist(
    (set, get) => ({
      ...
      addTransaction: (tx) => {
        ...
        set(s => {
          const txs = [newTx, ...s.transactions].sort((a, b) => b.date.localeCompare(a.date));
      ...
      addAccount: (name) => {
        const gradients = [
          ...
          "from-rose-600 to-rose-400", "from-amber-600 to-amber-400",
    ...
    {
      name: "spendwise-demo-v1", // isolated from real app data
      partialize: (s) => ({
        accounts:     s.accounts,
