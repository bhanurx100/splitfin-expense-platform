...
import { formatINR } from "@/src/features/transactions/lib/formatters";
      ...
      <div className="mb-4 flex rounded-xl bg-gray-100 p-1">
        {(["Expenses", "Income"] as const).map((t) => (
          <button
            ...
            className={`flex-1 rounded-lg py-2 text-xs font-medium transition-all duration-200 ${activeTab === t
