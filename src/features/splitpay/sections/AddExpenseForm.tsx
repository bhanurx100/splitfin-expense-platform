...
/**
 * features/splitpay/sections/AddExpenseForm.tsx
 *
 * Inline expense creation form — extracted from app/(dashboard)/split/page.tsx.
 * Tightly coupled to useExpenseForm; kept as a section rather than a generic
 * component because it owns submit logic and store wiring.
 *
 * Props:
 *   group    — the active Group (members + id)
 *   onClose  — called after successful submit or Cancel
 */

import { useState, useCallback } from "react";
import { Percent, Scale, Users, Receipt, Info } from "lucide-react";

import type { Group, SplitMethod } from "@/src/features/splitpay/types";
...
export function AddExpenseForm({ group, onClose }: Props) {
  ...
  return (
    <Card
      className={cn("p-4 lg:p-5", "dark:border-slate-700 dark:bg-slate-800/60")}
    >
