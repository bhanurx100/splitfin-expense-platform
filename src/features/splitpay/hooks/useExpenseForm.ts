...
import type { Expense, SplitMethod, Member } from "@/src/features/splitpay/types";
import { validateExpenseShares } from "@/src/features/splitpay/lib/calculations";
  ...
  const [form, setForm] = useState<ExpenseFormState>(() => {
    if (initialExpense) {
      ...
      return {
        ...
        currency:     initialExpense.currency ?? "INR",
      };
    }
